...
public class VerPorCategoria extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseFav = FirebaseDatabase.getInstance().getReference("Favoritos");
        ...
        btnFavorito.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Query q = databaseFav.orderByKey().equalTo(idUsuario);
                q.addListenerForSingleValueEvent(new ValueEventListener() {
                    int cont = 1;
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot datasnapshot : dataSnapshot.getChildren()) {
                            ...
                            Favs.add(datasnapshot.getValue().toString());
                            cont = Favs.size();
                            Toast.makeText(VerPorCategoria.this, "" + Favs, +Toast.LENGTH_SHORT).show();
                            

                        }

                        databaseFav.child(idUsuario).child("fav"+cont).setValue(keyUsuario);
                    }
